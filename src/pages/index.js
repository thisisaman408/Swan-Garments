...
import { AiFillFire, AiFillPlaySquare } from 'react-icons/ai';
...
const HomePage = () => {
	return (
		<>
			<Meta
				title="Swan Garmennts | Chandra and Chandra Creations"
				description="Swan Garments used to be my everything."
				image="/preview.png"
			/>

			<div
				className="max-w-[1290px] mx-auto pt-[50px] "
          ...
          w-[200px]
          md:mt-5">
							<span className="font-extrabold">Swan</span>
							<span className="font-normal drop-shadow-logo">Garments</span>
				...
				<div className="flex items-start gap-20 mt-[70px] md:mt-5 md:flex-col">
					<div className="max-w-[600px] mt-4 md:text-center">
						...
						<div
							...
							<div className="whitespace-nowrap">DRESSES TO</div>
							<div className="whitespace-nowrap">BE NOTICED</div>
						</div>
						...
						<ul className="flex  md:flex-col md:gap-5">
							...
							<li className="flex items-center gap-3 pl-[45px]">
								...
								<div className="text-white">
									...
									<Link href="/accessory" legacyBehavior>
										<a className="text-gray-200 text-sm hover:text-gray-400 transition duration-300 tracking-wider">
											See All
										</a>
									</Link>
